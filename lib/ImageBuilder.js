...
class ImageBuilder {
    ...
    createStorageAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.executeAzCliCommand(`dupa storage account create --name "${this.storageAccount}" --resource-group "${this._taskParameters.resourceGroupName}" --location "${this._taskParameters.location}" --sku Standard_RAGRS`);
